...
public class SnowstreamSettings {
    public static final String ClientBuildDate = "July 22, 2024";
    public static final String ClientVersion = "0.5.1";
	...
	public static String DevServerUrl = "http://192.168.1.4:8000";
	public static String ProdServerUrl = "http://192.168.1.4:8000";
    public static final int SearchDelayMilliseconds = 300;
    public static final int COLUMNS_PER_POSTER_GRID_ROW = 4;
}
