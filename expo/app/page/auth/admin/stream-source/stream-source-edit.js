...
export default function StreamSourceEditPage() {
    ...
    if (streamSourceId) {
        deleteButton = <C.SnowButton title={`Delete Stream Source (${streamSourceDeleteCount})`} onPress={deleteStreamSource} />
    }
    ...
    return (
        <C.View >
            ...
            <C.SnowDropdown options={streamSourceKinds} onChoose={chooseStreamSourceKind} value={streamSourceKind} />
            ...
            <C.SnowButton title="Save Stream Source" onPress={saveStreamSource} />
            {deleteButton}
        </C.View >
    )
}
