...
export var routes = {
    admin: {
        ...
        channelGuideSourceList: '/auth/admin/guide-source/guide-source-list',
        channelGuideSourceEdit: '/auth/admin/guide-source/guide-source-edit',
        channelStreamableEdit: '/auth/admin/guide-source/channel-streamable-edit',
