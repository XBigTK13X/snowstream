...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('image_file_id', sa.Integer, sa.ForeignKey('image_file.id'), nullable=False),
    )

    op.create_unique_constraint(
        'unique_movie_image_file',
        'movie_video_file',
    ...
    op.create_unique_constraint(
        'unique_show_image_file',
        'show_image_file',
        ['show_id', 'image_file_id']
    )
    ...
    op.create_table(
        ...
        sa.Column('updated_at', sa.DateTime, nullable=False),
        sa.Column('movie_id', sa.Integer, sa.ForeignKey('movie.id'), nullable=False),
        sa.Column('metadata_file_id', sa.Integer, sa.ForeignKey('metadata_file.id'), nullable=False),
    )
